...
% Pembuka
Penelitian ini berangkat dari berbagai penelitian terdahulu yang membahas pengenalan bahasa isyarat (sign language recognition) sebagai bagian dari pengenalan pola gerakan berbasis visual.
...
\endlastfoot
    ...
    \hline
    2.
    & [Jiayu Huang, VarinChouvatut ][2024][\textit{Video-Based Sign Language Recognition via ResNet and LSTM Network}] \cite{huang2024videoresnetlstm}
    &  
    &  
    & \\
    \hline
