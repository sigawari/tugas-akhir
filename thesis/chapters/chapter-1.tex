...
Dua bahasa tersebut adalah Sistem Bahasa Isyarat Indonesia (SIBI) dan Bahasa Isyarat Indonesia (BISINDO) \cite{olivia2022tindakankomunikatif}. 
SIBI lebih umum digunakan pada kegiatan formal dan akademis karena dibuat oleh pemerintah dan Teman Dengar dengan mengadaptasi sistem bahasa isyarat Amerika (\textit{American Sign Language} (ASL)) \cite{nilawaty2020sibi} \cite{saraswati2022bisindo}. 
...
Belum banyak yang memanfaatkan model berbasis spasial seperti CNN atau ResNet dalam klasifikasi bahasa isyarat maupun BISINDO. 
Penelitian-penelitian yang memanfaatkan model spasial untuk tugas ini kebanyakan menggunakan dataset statis dan cenderung mengabaikan aspek urutan yang penting dalam pengenalan bahasa isyarat. 
