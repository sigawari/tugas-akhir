...
% 	\rfoot{Halaman \thepage}%
    ...
    % Judul Tugas Akhir
    \title{Reka Cipta Pemanfaatan ResNet-2D dalam Penerjemahan Bahasa Isyarat Indonesia (BISINDO) Berbasis \textit{Landmark} Mediapipe} % Judul Tugas Akhir dalam Bahasa Indonesia	
