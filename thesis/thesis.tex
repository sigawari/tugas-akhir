...
% 	\rfoot{Halaman \thepage}%
    ...
    % Judul Tugas Akhir
    \title{Reka Cipta Sistem Penerjemah Bahasa Isyarat Indonesia (BISINDO) Ke Kata Menggunakan \textit{Long Short-Term Memory} (LSTM)} % Judul Tugas Akhir dalam Bahasa Indonesia	
