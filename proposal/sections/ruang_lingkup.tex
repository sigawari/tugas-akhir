...
Data masukan model tidak berupa citra RGB mentah, melainkan representasi koordinat \textit{landmark} tubuh hasil ekstraksi MediaPipe yang terdiri atas nilai posisi dan perubahan posisi titik, yaitu $(x, y, dx, dy)$.
